    ...
    "effects": [
        {
            "name": "add_reverb",
            "params": {
                "room_size": {"random_type": "uniform", "min": 0.5, "max": 0.7},      # 模拟一个较大的房间 (0到1)
...

        {
            ...
            "params": {
                ...
                "cutoff_hz": {"random_type": "uniform", "min": 1000, "max": 3000},
...

        {
            "name": "change_volume",
            "params": {
                "target_lufs": {"random_type": "uniform", "min": -50, "max": -40}  # 音量降低12分贝，模拟距离衰减
            }
        },
        {
            "name": "adjust_speed",
